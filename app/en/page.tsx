...
export default function HomePage() {
  return (
    <div className="bg-black text-white overflow-hidden font-sans antialiased">
      <SiteHeader variant="transparent" locale="en" />

      <main className="relative flex flex-col md:flex-row h-[100dvh] w-full">
        <h1 className="sr-only">Statoplast | Modern Architecture & Industrial Metalworking</h1>
        ...
        >
          ...
          <div className="relative z-10 transform md:group-hover:-translate-y-4 transition-transform duration-700 ease-out">
            ...
            <p className="text-xs sm:text-sm lg:text-base text-zinc-400 mb-4 md:mb-8 max-w-sm sm:max-w-md leading-relaxed">
              Pivot doors, bioclimatic pergolas and advanced aluminium joinery systems. A blend of
              top-tier engineering and minimalist aesthetics.
            </p>
        ...
        >
          ...
          <div className="relative z-10 transform md:group-hover:-translate-y-4 transition-transform duration-700 ease-out">
            ...
            <p className="text-xs sm:text-sm lg:text-base text-zinc-400 mb-4 md:mb-8 max-w-sm sm:max-w-md leading-relaxed">
              Metal powder coating, CNC machining and series production of electrical cabinets.
              Precision and capacity for large-scale projects.
            </p>
            <div className="inline-flex items-center space-x-4">
