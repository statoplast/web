        ...
        <div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-16">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg text-slate-400 mb-6 leading-relaxed">
                Speed, high precision and optimal material use. Our advanced lasers enable precise
                cutting of complex contours from sheet materials with maximum repeatability.
              </p>
              <p className="text-sm text-slate-500 mb-8 leading-relaxed">
                A flexible solution both for rapid prototyping and for mass series production of
                parts in the modern metalworking industry.
              </p>
              <div className="bg-slate-800/50 p-6 rounded-xl border border-slate-700/50 backdrop-blur-sm">
                <ul className="space-y-2 font-medium text-slate-200 text-sm">
                  <li className="flex items-center gap-2">
                    <span className="text-blue-500">✓</span> Cutting mild steel, aluminium and
                    stainless steel
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-blue-500">✓</span> High efficiency and optimal material
                    nesting
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-blue-500">✓</span> Option to engrave and mark parts on
                    the sheet
                  </li>
                </ul>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-slate-800/30 p-8 rounded-xl border border-slate-800 flex flex-col justify-center">
              <h4 className="text-white font-bold text-xl mb-3">From drawing to finished part</h4>
              <p className="text-slate-400 text-sm leading-relaxed">
                We prepare your CAD and DXF drawings using advanced software, optimising the
                cutting process to ensure maximum material yield and the most cost-effective
                quote.
              </p>
            </div>
          </div>
