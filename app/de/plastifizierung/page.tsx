...
export default function MetallbeschichtungPage() {
  return (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-16">
            <div className="order-2 lg:order-1 rounded-2xl overflow-hidden border border-slate-800 relative group">
              ...
              <img
                ...
                alt="Metallbeschichtung - Hauptlinie"
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg text-slate-400 mb-6 leading-relaxed">
                Wir bieten elektrostatische Pulverbeschichtung mit Schwerpunkt auf Langlebigkeit
                und erstklassiger ästhetischer Optik. Ob Serienproduktion oder einzelne Elemente
                größerer Abmessungen — unsere Anlage ist auf höchste Industriestandards
                ausgerichtet.
              </p>
              <p className="text-sm text-slate-500 mb-8 leading-relaxed">
                Eine gründliche chemische Vorbehandlung (Entfettung und Phosphatierung)
                garantiert maximale Haftung der Beschichtung auf Stahl-, verzinkten oder
              ...
              <div className="bg-slate-800/50 p-6 rounded-xl border border-slate-700/50 backdrop-blur-sm">
                <ul className="space-y-2 font-medium text-slate-200 text-sm">
                  <li className="flex items-center gap-2">
                    <span className="text-blue-500">✓</span> Automatische Linie für große Serien
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-blue-500">✓</span> Handkabine für großformatige
                    Elemente
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-blue-500">✓</span> Umweltfreundlicher, lösemittelfreier
                    Prozess
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-blue-500">✓</span> Unbegrenzte Farbauswahl nach
                    RAL-Karte (matt, glänzend, fein- und grobstrukturiert)
                  </li>
                </ul>
              </div>
            </div>
