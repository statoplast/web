...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: "Statoplast",
    title: "Statoplast | Über uns",
    description: "Erfahren Sie mehr über Statoplast. Mit über 30 Jahren Erfahrung in der Metallverarbeitung verbinden wir Familientradition mit modernster CNC-Technologie.",
    url: "/de/uber-uns/",
        ...
        <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 font-light">
              ...
              <li>
                <Link href="/de/projekte" className="hover:text-white transition-colors">
                  Projekte
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-zinc-800/60 py-6 text-xs text-zinc-500">
          <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
              <Link href="/de/datenschutz" className="hover:text-zinc-300 transition-colors">
                Datenschutzerklärung
              </Link>
              <Link href="/de/nutzungsbedingungen" className="hover:text-zinc-300 transition-colors">
                Nutzungsbedingungen
              </Link>
              <span>
                Design & Entwicklung:{" "}
