...
export const metadata: Metadata = {
  ...
  description:
    "Vrhunska plastifikacija metala i antikorozivna zaštita. Statoplast nudi elektrostatsko plastificiranje po RAL karti za velike i male serije. Saznajte više!",
};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-16">
            <div className="order-2 lg:order-1 rounded-2xl overflow-hidden border border-slate-800 relative group">
              ...
              <img
                ...
                alt="Plastifikacija metala - Glavna linija"
            ...
            <div className="order-1 lg:order-2">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <span className="text-xs font-bold uppercase tracking-widest text-blue-400">
                  Vrhunska antikorozivna zaštita
                </span>
              </div>
              ...
              <p className="text-lg text-slate-400 mb-6 leading-relaxed">
                Pružamo uslugu elektrostatskog nanošenja praha (plastificiranja) s naglaskom na
                dugotrajnost i vrhunski estetski izgled. Bilo da se radi o serijskoj proizvodnji ili
                pojedinačnim elementima većih dimenzija, naš pogon je prilagođen najvišim
                industrijskim standardima.
              </p>
              <p className="text-sm text-slate-500 mb-8 leading-relaxed">
                Temeljita kemijska priprema (odmašćivanje i fosfatiranje) jamči maksimalno prianjanje
                boje na čelične, pocinčane ili aluminijske površine.
              </p>
              <div className="bg-slate-800/50 p-6 rounded-xl border border-slate-700/50 backdrop-blur-sm">
                <ul className="space-y-2 font-medium text-slate-200 text-sm">
                  <li className="flex items-center gap-2">
                    <span className="text-blue-500">✓</span> Automatska linija za velike serije
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-blue-500">✓</span> Ručna kabina za elemente velikih
                    dimenzija
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-blue-500">✓</span> Ekološki prihvatljiv proces bez
                    otapala
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-blue-500">✓</span> Neograničen izbor boja po RAL karti
                    (mat, sjaj, fina i gruba struktura)
                  </li>
                </ul>
              </div>
            </div>
